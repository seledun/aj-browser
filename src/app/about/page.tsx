...
export default function AboutPage() {
    return (
        ...
        <div className="border border-divider rounded-lg p-6 text-center text-default-500">
            <p className="text-lg">GitHub Repository: <a href="https://github.com/seledun/aj-browser" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">https://github.com/seledun/aj-browser</a></p>
        </div>
        </div>
    );
}